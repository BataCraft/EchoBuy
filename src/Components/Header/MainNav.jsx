...
const MainNav = () => {
  return (
    <>
      <header className=' w-full h-[50px] lg:h-[100px] flex justify-between items-center px-2 mx-auto md:px-8 lg:px-[132px] fixed z-[999] bg-white'>
        <div className="logo">
          <NavLink to='/'>
        ...
        <div id="middle_part" className=' px-4  items-baseline gap-20 justify-center border-r-2 border-r-slate-200 hidden lg:flex'>
          <div className='xl:w-[50rem] md:w-[30rem] px-2 border-[2px] flex items-center justify-center rounded-md border-[#dadada] '> <input type="search" name="search" id="search" placeholder='Search here...' className=' w-full h-[3rem]  outline-none ' />
      ...
      <section className='w-full bg-white absolute top-[50px] z-[100] p-2'>
